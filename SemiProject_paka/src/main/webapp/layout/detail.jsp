      ...
      <div class="detailall">
         ...
         <div style="height: 1400px;">
            ...
            %> <%= myid %>
                           ...
                           <button type="button" class="button button-first" data-type="square" id="btnadd"><b style="color: black;">댓글등록</b></button>
               </td>
               
               <script src="js/buttonEvent.js"></script>
               <link href="css/buttonEvent.css" rel="stylesheet" type="text/css">
