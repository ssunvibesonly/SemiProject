...
<body>
	<div style="margin: 60px 515px; width:100% ; height:600px;">
		<form action="member/memberproc.jsp" method="post" class="form-inline" id="mfrm">
			<table class="table table-bordered" style="width: 500px; position: absolute;">
				<caption align="top" style="color: gray; font-weight: bold;">회원가입</caption>
				<tr>
